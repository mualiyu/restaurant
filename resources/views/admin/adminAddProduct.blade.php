...
<section id="main-content">
    ...
    <section>
        <div class="row">
            <form action="{{route('adminAddProductToDB')}}" method="post" enctype="multipart/form-data" class="col-12">
                ...
                <div class="col-lg-3 col-md-12 ">
                    ...
                    <div class="panel-body">
                        <div>
                            <img id="addimage" src="{{asset('storage/product_imgs/default_product.png')}}" class=" img-thumbnail" style="max-height:200px; min-height:200px; min-width:150px;" alt="">
                        </div><br>
                        <div class="form-group">
                            <input type="file" id="addIsrc" onclick="imageQ('addIsrc','addimage');" name="image" value="default_product.png" class="form-control">
                        </div>
                    </div>
                    </div>
                </div>
